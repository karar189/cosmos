...
function DocSidebar() {
  ...
  return (
    <aside className="hidden w-[220px] shrink-0 lg:block">
      <nav className="sticky top-14 space-y-8 pr-4">
        {DOC_NAV.map((group) => (
          <div key={group.label}>
...
export function DocPageView({ page }: { page: DocPage }) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-[1200px] items-start gap-10 px-6 pb-8 pt-14 md:px-10">
      <DocSidebar />
...
export function DocMobileNav() {
  ...
  return (
    <div className="sticky top-[72px] z-20 border-b border-white/[0.06] bg-black/50 px-6 py-3 backdrop-blur-md lg:hidden">
      <select
