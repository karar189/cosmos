...
export default function ProjectHeader({
  ...
  const handleBack = () => {
    ...
    const targetUrl = ROUTES.RATINGS.EXCHANGES;
        ...
        {showBackButton && (
          ...
          >
            <MotionButton
              ...
              whileHover={{ x: -4 }}
              whileTap={{ scale: 0.98 }}
              aria-label={t("layout.backToExchanges", "Back to Exchange Ratings")}
            >
              <Icon name="chevron-left" css={styles.backIcon} />
              <span>{t("layout.backToExchanges", "Back to Exchange Ratings")}</span>
            </MotionButton>
          </MotionDiv>
        )}
              ...
              <MotionDiv css={styles.badges} style={{ opacity: badgesOpacity }}>
                ...
                <div css={styles.projectBadge}>
                  ...
                  <div css={styles.starsWrapper}>
                    <Stars value={getExchangeCertificationLevel(data.certification)} />
                  </div>
                </div>
              </MotionDiv>
            </MotionDiv>
