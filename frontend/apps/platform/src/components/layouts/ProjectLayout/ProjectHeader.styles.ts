...
import { flex, spacing, typography, colors, borders, transitions, spacingValues, sizeValues, size, background, cursor, overflow, objectFit, position, breakpoints } from '@core3/ui-components/styleSystem';
...
export const header = css`
  ...
  /* Increase padding and gap on desktop */
  ${breakpoints.md} {
    ${spacing.gap.l}
